...
// import { FaReddit, FaSearch, FaBell, FaUserCircle, FaEdit } from 'react-icons/fa'
...
//                             <label htmlFor="search-content" className='search-icon-container'> <FaSearch size={"20px"} /></label>
//                             <input {...register("search-content")}  type="text" name="search-content" id="search-content-bar" placeholder='Search Wallpapers By Tag...' />
//                         </form>
//                     </div>
//                     <div className='auth-container navbar-item'>
//                         {/* <button className='sing-in-btn'>SignIn</button>
//                         <button className='sing-out-btn'>SignOut</button> */}
//                         {/* <span>
//                             <FaBell />
//                         </span> */}
